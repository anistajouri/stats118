...
@Component({
  selector: 'map-departements',
  templateUrl: './mapdepartements.component.html',
  styleUrls: ['./mapdepartements.component.css']
})
export class MapdepartementsComponent implements OnInit, OnChanges {
  ...
  name_dep: string;
  @Output() namedepartmentChange = new EventEmitter();
  dep_clicked: number;
  @Output() departmentChange = new EventEmitter();
  @Input() dephovered:  string;
  ...
  ngOnChanges(changes: SimpleChanges){
    ...
    this.percentages= changes.percentages.currentValue;
  ...
  var max = 0;
    ...
    if(this.departements[i].percent >= 30 ){
      this.departements[i].fill ="#376b25" ;
    }
    else  if((this.departements[i].percent >= 20) && (this.departements[i].percent < 30) ){
      ...
      this.name_dep = this.departements[this.dep_sup_postion].title
      this.dephovered= this.name_dep;
      this.departmentChange.emit(this.dep_clicked);
      this.namedepartmentChange.emit(this.name_dep);
...
setDep_clicked(dep,i){
  var d = parseInt(dep);
  this.dep_clicked =d;
  this.departmentChange.emit(this.dep_clicked);
  this.name_dep = this.departements[i].title;
  this.namedepartmentChange.emit(this.name_dep);
}

  ngOnInit() {
    this.dephovered  = "";
    console.log("percentages: "+ JSON.stringify(this.percentages))
  }
